...
# CRM customization (ADR-011): specs live under agent-os/specs/, not top-level specs/.
# Re-apply this change after any `specify` CLI upgrade that regenerates this script.
$specsDir = Join-Path $repoRoot 'agent-os/specs'
if (-not $DryRun) {
